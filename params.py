params=dict(
    ...
    # generatorPath='./generatorLJ.pth',
    # refinerPath='./refinerLJ.pth',
    # discriminatorPath='./discriminatorLJ.pth',
    trainDataPath='C:/deep_learning/speech_synthesis/VCTK_all22050',
    generatorPath='./generatorVCTK.pth',
    refinerPath='./refinerVCTK.pth',
    discriminatorPath='./discriminatorVCTK.pth',
    trainEpoch=100,
    dropKeyEndEpoch=95,
    trainBatch=8,
    trainDevice='cuda:0',
    ...
    # schedulerEpoch=10,
    # schedulerStep=4,
    # schedulerLearnRate=0.5,
    # schedulerTrainBatch=8,
    # generatorPathSch='./generatorLJ.pth',
    # refinerPathSch='./refinerLJ.pth',
    # discriminatorPathSch='./discriminatorLJ.pth',
    # schedulerPath='./schedulerLJ.pth',
    # schedulerTrainDataPath='C:/deep_learning/speech_synthesis/LJSPeech/LJSpeech_1.1/wavs',
    # schedulerTrainDevice='cuda:0',
    schedulerEpoch=10,
    schedulerStep=4,
    schedulerLearnRate=0.2,
    schedulerTrainBatch=8,
    ...
    # generatorPathInf='./generatorLJ.pth',
    # refinerPathInf='./refinerLJ.pth',
    # inferenceDevice='cuda:0',
    # schedulerPathInf='./schedulerLJ.pth',
